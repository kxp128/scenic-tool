...
public class CodeGenerator {
    ...
    //填写自己项目的包路径
    public static final String BASE_PACKAGE = "com.lsn.user";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    //根据项目实际位置修改 如 /scenic-tool-user
    private static final String PROJECT_PATH = System.getProperty("user.dir")+"/scenic-tool-user";//项目在硬盘上的基础路径
